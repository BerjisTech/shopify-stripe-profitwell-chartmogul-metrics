...
class ResourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create resource' do
    assert_difference('Resource.count') do
      post resources_url, params: { resource: { resource: @resource.resource, task_id: @resource.task_id } }
    end
  ...
  test 'should update resource' do
    patch resource_url(@resource), params: { resource: { resource: @resource.resource, task_id: @resource.task_id } }
