...
class SubTasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create sub_task' do
    assert_difference('SubTask.count') do
      post sub_tasks_url,
           params: { sub_task: { assigned_by: @sub_task.assigned_by, assigned_to: @sub_task.assigned_to,
                                 deadline: @sub_task.deadline, task: @sub_task.task } }
    end
